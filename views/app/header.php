<header id="app_header">
			...
			<nav id="app_menu">
				<ul>
					<li class="current"><a href="<?= $_SERVER['PHP_SELF'] . '?section=meal&page=calendar_week'; ?>">This Week</a></li>
					<li><a href="<?= $_SERVER['PHP_SELF'] . '?section=dish&page=list_view'; ?>">Dish Archive</a></li>
					<!-- FOR LATER <li><a href="<?= $_SERVER['PHP_SELF'] . '?section=meal&page=calendar_month'; ?>">Calendar</a></li> -->
