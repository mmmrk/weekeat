...
--
-- Host: localhost
-- Generation Time: Sep 10, 2013 at 06:47 PM
...
--
-- Stand-in structure for view `available_dotd_dishes`
--
CREATE TABLE IF NOT EXISTS `available_dotd_dishes` (
`id` int(10) unsigned
,`name` varchar(100)
,`description` varchar(200)
,`url` varchar(200)
...
(14, 'körv å mos', 'n''t g''tt', NULL, 'ta lite shit\r\nlägg på en korv\r\nwin', '2013-07-26 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `dish_of_the_day` (
  `date` date NOT NULL,
...
--
-- Dumping data for table `dish_of_the_day`
--

INSERT INTO `dish_of_the_day` (`date`, `dish_id`) VALUES
('2013-07-31', 3),
('2013-09-10', 3),
('2013-07-27', 4),
('2013-07-10', 6),
...
INSERT INTO `meal` (`id`, `date`, `dish_id`, `name`, `shopping_list`, `created_at`) VALUES
(1, '0000-00-00', 5, 'ett', NULL, '0000-00-00 00:00:00'),
(2, '2012-05-01', 7, 'två', NULL, '0000-00-00 00:00:00'),
(3, '2012-05-13', 4, 'tre', NULL, '0000-00-00 00:00:00'),
(4, '2012-05-14', 4, 'fyra', NULL, '0000-00-00 00:00:00'),
(5, '2012-05-18', 3, 'fem', NULL, '0000-00-00 00:00:00'),
(6, '2012-05-19', 6, 'sex', NULL, '0000-00-00 00:00:00'),
(7, '2012-05-20', 8, 'sju', NULL, '0000-00-00 00:00:00'),
(8, '2012-05-21', 7, 'åtta', NULL, '0000-00-00 00:00:00'),
(9, '2012-05-23', 12, 'nio', NULL, '0000-00-00 00:00:00'),
(10, '2012-05-24', 13, 'tio', NULL, '0000-00-00 00:00:00'),
(11, '2012-05-25', 10, 'elva', NULL, '0000-00-00 00:00:00'),
(12, '2012-06-04', 5, 'tolv', NULL, '0000-00-00 00:00:00'),
(13, '2012-07-14', 7, 'tretton', NULL, '0000-00-00 00:00:00'),
(14, '2012-07-23', 7, 'fjorton', NULL, '0000-00-00 00:00:00'),
(15, '2012-07-25', 11, 'femton', NULL, '0000-00-00 00:00:00'),
(16, '2012-08-13', 5, 'sexton', NULL, '0000-00-00 00:00:00'),
(17, '2012-10-01', 5, 'sjutton', NULL, '0000-00-00 00:00:00'),
(18, '2012-10-13', 7, 'arton', NULL, '0000-00-00 00:00:00'),
(19, '2012-10-20', 7, 'nitton', NULL, '0000-00-00 00:00:00'),
(20, '2013-07-25', 6, 'tjugo', NULL, '0000-00-00 00:00:00'),
(21, '2013-07-27', 13, 'tjugoett', NULL, '0000-00-00 00:00:00'),
(22, '2013-07-27', 11, 'tjugotvå', 'en av varje', '0000-00-00 00:00:00');
...
--
-- Stand-in structure for view `ready_for_dotd`
--
CREATE TABLE IF NOT EXISTS `ready_for_dotd` (
`id` int(11) unsigned
,`name` varchar(100)
,`description` varchar(200)
,`url` varchar(200)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `available_dishes` AS select `dish`.`id` AS `id`,`dish`.`name` AS `name`,`dish`.`description` AS `description`,`dish`.`url` AS `url`,`dish`.`recipe` AS `recipe`,`dish`.`created_at` AS `created_at`,`dish`.`updated_at` AS `updated_at` from `dish` where (not(`dish`.`id` in (select `meal`.`dish_id` from `meal` where (`meal`.`date` between (curdate() - interval 10 day) and (curdate() + interval 10 day)))));

-- --------------------------------------------------------

--
-- Structure for view `available_dotd_dishes`
--
DROP TABLE IF EXISTS `available_dotd_dishes`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `available_dotd_dishes` AS select `dish`.`id` AS `id`,`dish`.`name` AS `name`,`dish`.`description` AS `description`,`dish`.`url` AS `url`,`dish`.`recipe` AS `recipe`,`dish`.`created_at` AS `created_at`,`dish`.`updated_at` AS `updated_at` from `dish` where (not(`dish`.`id` in (select `meal`.`dish_id` from `meal` where (`meal`.`date` between (curdate() - interval 10 day) and (curdate() + interval 10 day)) union select `dish_of_the_day`.`dish_id` from `dish_of_the_day` where (`dish_of_the_day`.`date` between (curdate() - interval 10 day) and (curdate() + interval 10 day)))));
...
--
-- Structure for view `ready_for_dotd`
--
DROP TABLE IF EXISTS `ready_for_dotd`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `ready_for_dotd` AS select `available_dotd_dishes`.`id` AS `id`,`available_dotd_dishes`.`name` AS `name`,`available_dotd_dishes`.`description` AS `description`,`available_dotd_dishes`.`url` AS `url`,`available_dotd_dishes`.`recipe` AS `recipe`,`available_dotd_dishes`.`created_at` AS `created_at`,`available_dotd_dishes`.`updated_at` AS `updated_at` from `available_dotd_dishes` union all select `uneaten_dishes`.`id` AS `id`,`uneaten_dishes`.`name` AS `name`,`uneaten_dishes`.`description` AS `description`,`uneaten_dishes`.`url` AS `url`,`uneaten_dishes`.`recipe` AS `recipe`,`uneaten_dishes`.`created_at` AS `created_at`,`uneaten_dishes`.`updated_at` AS `updated_at` from `uneaten_dishes`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `ready_to_eat` AS select `available_dishes`.`id` AS `id`,`available_dishes`.`name` AS `name`,`available_dishes`.`description` AS `description`,`available_dishes`.`url` AS `url`,`available_dishes`.`recipe` AS `recipe`,`available_dishes`.`created_at` AS `created_at`,`available_dishes`.`updated_at` AS `updated_at` from `available_dishes` union all select `uneaten_dishes`.`id` AS `id`,`uneaten_dishes`.`name` AS `name`,`uneaten_dishes`.`description` AS `description`,`uneaten_dishes`.`url` AS `url`,`uneaten_dishes`.`recipe` AS `recipe`,`uneaten_dishes`.`created_at` AS `created_at`,`uneaten_dishes`.`updated_at` AS `updated_at` from `uneaten_dishes`;
...
--
-- Constraints for table `dish_of_the_day`
--
ALTER TABLE `dish_of_the_day`
  ADD CONSTRAINT `dish_of_the_day_ibfk_1` FOREIGN KEY (`dish_id`) REFERENCES `dish` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
